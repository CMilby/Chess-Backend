/*
 * @Author: Craig Milby 
 * @Date: 2019-04-20 14:02:05 
 * @Last Modified by: Craig Milby
 * @Last Modified time: 2019-04-20 14:15:56
 */
...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
	...
	// @Value ( "${security.jwt.access-token-time-seconds}" )
	...
	// Exception {
	// configurer.inMemory ( ).withClient ( clientId ).secret (
	...
	// .tokenEnhancer ( enhancerChain ).authenticationManager (
